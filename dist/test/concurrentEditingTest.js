...
describe('concurrent editing', function () {
    ...
    it('syncs', function () {
        ...
        var leftCodeMirrorChangeHandler = makeCodeMirrorChangeHandler_1.default(leftWatchableDoc, getText, leftMutex);
        ...
        var rightCodeMirrorChangeHandler = makeCodeMirrorChangeHandler_1.default(rightWatchableDoc, getText, rightMutex);
        ...
        rightDocSet.registerHandler(function (_, newDoc) {
            right = updateCodeMirrorDocs_1.default(right, newDoc, rightLinks, rightMutex);
        });
